...
EndOfLoop:
            ...
            updateLoadData(varSessionID, varShipmentID)

            updateUsedContainers(varSessionID, varShipmentID)
            updateUnUsedContainers(varSessionID, varShipmentID)
        ...
        Public Shared Function updateUsedContainers(ByVal varSessionID As String, ByVal varShipmentID As Integer)
            Dim connection As SqlConnection = New SqlConnection(System.Configuration.ConfigurationManager.AppSettings("connectionstring"))
            Dim connection2 As SqlConnection = New SqlConnection(System.Configuration.ConfigurationManager.AppSettings("connectionstring"))
        ...
        Public Shared Function clearTmpLoadData(ByVal varsessionID As String, ByVal varShipmentID As String)
            ...
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.AddWithValue("@sessionID", varsessionID)
        ...
        Public Shared Function setNextTestPosNextRowFrontFloor(ByVal xT)
            ...
            If surfaceArr(xT, 12) = "used" And CDec(surfaceArr(xT, 1)) <= p5x And _
        ...
        Public Shared Function findVertSurf()
            ...
            For sDx = noSurfRemoved To noSurfLoaded
                ...
                If surfaceArr(sDx, 12) = "used" And CDec(surfaceArr(sDx, 19)) < tmpTestPosL And _
                CDec(surfaceArr(sDx, 1)) < posW And CDec(surfaceArr(sDx, 26)) > p5y And CDec(surfaceArr(sDx, 3)) <= p2z And _
                CDec(surfaceArr(sDx, 18)) > posH And CDec(surfaceArr(sDx, 19)) >= minTrailerLength - 96 Then

                    vSurfFound = True
                End If

                If surfaceArr(sDx, 12) = "used" And CDec(surfaceArr(sDx, 19)) < tmpTestPosL And CDec(surfaceArr(sDx, 1)) >= posW And _
                CDec(surfaceArr(sDx, 1)) < p5y And CDec(surfaceArr(sDx, 3)) <= p2z And CDec(surfaceArr(sDx, 18)) > posH And _
                CDec(surfaceArr(sDx, 19)) >= minTrailerLength - 96 Then

                    vSurfFound = True
                End If

                If surfaceArr(sDx, 12) = "used" And CDec(surfaceArr(sDx, 19)) < tmpTestPosL And CDec(surfaceArr(sDx, 26)) >= posW And _
                CDec(surfaceArr(sDx, 26)) < p5y And CDec(surfaceArr(sDx, 3)) <= p2z And CDec(surfaceArr(sDx, 18)) > posH And _
                CDec(surfaceArr(sDx, 19)) >= minTrailerLength - 96 Then
                ...
                If surfaceArr(sDx, 12) = "used" And CDec(surfaceArr(sDx, 19)) < tmpTestPosL And CDec(surfaceArr(sDx, 1)) < posW And _
                CDec(surfaceArr(sDx, 26)) > posW And CDec(surfaceArr(sDx, 3)) <= p2z And CDec(surfaceArr(sDx, 18)) > posH And _
    CDec(surfaceArr(sDx, 19)) >= minTrailerLength - 96 Then
                    vSurfFound = True
                End If
        ...
        Public Shared Function findVertSurfRight()
            ...
            For sDx = noSurfRemoved To noSurfLoaded
                ...
                If surfaceArr(sDx, 12) = "used" And CDec(surfaceArr(sDx, 26)) < tmpTestPosW And _
                CDec(surfaceArr(sDx, 2)) < posL And CDec(surfaceArr(sDx, 19)) > p3x And CDec(surfaceArr(sDx, 3)) <= p2z And _
                CDec(surfaceArr(sDx, 18)) > posH And CDec(surfaceArr(sDx, 19)) >= minTrailerLength - 96 Then

                    vSurfRightFound = True
                End If

                If surfaceArr(sDx, 12) = "used" And CDec(surfaceArr(sDx, 26)) < tmpTestPosW And CDec(surfaceArr(sDx, 2)) >= posL And _
                CDec(surfaceArr(sDx, 2)) < p3x And CDec(surfaceArr(sDx, 3)) <= p2z And CDec(surfaceArr(sDx, 18)) > posH And _
                CDec(surfaceArr(sDx, 19)) >= minTrailerLength - 96 Then

                    vSurfRightFound = True
                End If

                If surfaceArr(sDx, 12) = "used" And CDec(surfaceArr(sDx, 26)) < tmpTestPosW And CDec(surfaceArr(sDx, 19)) >= posL And _
                CDec(surfaceArr(sDx, 19)) < p3x And CDec(surfaceArr(sDx, 3)) <= p2z And CDec(surfaceArr(sDx, 18)) > posH And _
                CDec(surfaceArr(sDx, 19)) >= minTrailerLength - 96 Then
        ...
        Public Shared Function setNextTestPosShiftRearward(ByVal xTsub)
            ...
            If surfaceArr(xTsub, 12) = "used" And CDec(surfaceArr(xTsub, 19)) > posL And _
            CDec(surfaceArr(xTsub, 1)) >= posW And CDec(surfaceArr(xTsub, 1)) < p5y And CDec(surfaceArr(xTsub, 3)) >= posH And CDec(surfaceArr(xTsub, 3)) < p2z And _
            ...
            Or surfaceArr(xTsub, 12) = "used" And CDec(surfaceArr(xTsub, 19)) > posL And _
            CDec(surfaceArr(xTsub, 26)) > posW And CDec(surfaceArr(xTsub, 26)) <= p5y And CDec(surfaceArr(xTsub, 3)) >= posH And CDec(surfaceArr(xTsub, 3)) < p2z And _
        ...
        Public Shared Function setNextTestPosShiftDown(ByVal xTsub)
            If posH > 0 Then
                ...
                If surfaceArr(xTsub, 12) = "used" And CDec(surfaceArr(xTsub, 2)) >= posL And _
            ...
            For sDx = noSurfRemoved To noSurfLoaded
                ...
                If surfaceArr(sDx, 4) <> cntLoading Then
                    ...
                    If posL >= tmpPosL And posL < tmpP3x Or p8x > posL And p8x <= tmpP8x Or posL < tmpPosL And p3x > tmpP3x Then
                        ...
                        If posL >= surfPosL And posL < surfP3x And _
                                        posW >= surfPosW And posW < surfP5y And _
                        ...
                        If p3x > surfPosL And p3x <= surfP3x And _
                                            p3y >= surfPosW And p3y < surfP5y And _
                                            posH < surfP2z And p2z > tmpPosH Then
                            hitFlagCnt = True
                        End If
                        ...
                        surfP5y = CDec(surfaceArr(sDx, 26))
                        surfP2z = CDec(surfaceArr(sDx, 18))
                        If p5x >= surfPosL And p5x < surfP3x And _
                            p5y > surfPosW And p5y < surfP5y And _
                            posH < surfP2z And p2z > tmpPosH Then
                            hitFlagCnt = True
                        End If
                        ...
                        If p7x > surfPosL And p7x < surfP3x And p7y > surfPosW And _
            ...
            Else
                ...
                For sGx = noSurfRemoved To noSurfLoaded - 1
                    ...
                    If CDec(surfaceArr(sGx, 19)) = posL Then
                        ...
                        If posL = CDec(surfaceArr(sGx, 19)) And posW >= CDec(surfaceArr(sGx, 1)) And posW < CDec(surfaceArr(sGx, 26)) And _
                        ...
                        If posL = CDec(surfaceArr(sGx, 19)) And p5y >= CDec(surfaceArr(sGx, 1)) And p5y <= CDec(surfaceArr(sGx, 26)) And _
                        ...
                        If posL = CDec(surfaceArr(sGx, 19)) And p6y >= CDec(surfaceArr(sGx, 1)) And p6y <= CDec(surfaceArr(sGx, 26)) And _
                        ...
                        If posL = CDec(surfaceArr(sGx, 19)) And p2y >= CDec(surfaceArr(sGx, 1)) And p2y < CDec(surfaceArr(sGx, 26)) And _
            ...
            Else
                ...
                For sGx = noSurfRemoved To noSurfLoaded - 1
                    ...
                    If CDec(surfaceArr(sGx, 26)) = posW Then
                        ...
                        If posW = CDec(surfaceArr(sGx, 26)) And posL >= CDec(surfaceArr(sGx, 2)) And posL < CDec(surfaceArr(sGx, 19)) And _
                        posH >= CDec(surfaceArr(sGx, 3)) And posH < CDec(surfaceArr(sGx, 18)) Then
                        ...
                        If posW = CDec(surfaceArr(sGx, 26)) And p3x >= CDec(surfaceArr(sGx, 2)) And p3x <= CDec(surfaceArr(sGx, 19)) And _
                        p5z >= CDec(surfaceArr(sGx, 3)) And p5z < CDec(surfaceArr(sGx, 18)) Then
                        ...
                        If posW = CDec(surfaceArr(sGx, 26)) And p4x >= CDec(surfaceArr(sGx, 2)) And p4x <= CDec(surfaceArr(sGx, 19)) And _
                        p6z >= CDec(surfaceArr(sGx, 3)) And p6z <= CDec(surfaceArr(sGx, 18)) Then
                        ...
                        If posW = CDec(surfaceArr(sGx, 26)) And p2x >= CDec(surfaceArr(sGx, 2)) And p2x < CDec(surfaceArr(sGx, 19)) And _
                        p2z > CDec(surfaceArr(sGx, 3)) And p2z <= CDec(surfaceArr(sGx, 18)) Then

                            verticalContactRight = True
                        End If

                        If posW = CDec(surfaceArr(sGx, 26)) And posL < CDec(surfaceArr(sGx, 2)) And p3x > CDec(surfaceArr(sGx, 19)) And _
